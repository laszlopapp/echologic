...
class TagTest < ActiveSupport::TestCase
  ...
  def test_insertion
    ...
    assert_difference('Tag.count', 1, "should insert 1 value in german") do
      Tag.find_or_create_with_like_by_value("kaptainerdbeben",2)
    end
    ...
    assert_difference('Tag.count', 4, "should insert 4 values in german") do
      Tag.find_or_create_all_with_like_by_value("johan","helmut","franz","klaus",2)
    end
