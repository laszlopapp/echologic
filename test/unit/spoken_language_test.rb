...
class SpokenLanguageTest < ActiveSupport::TestCase
  context "a spoken language" do
    ...
    context "being saved" do
      setup do 
        @spoken_language.update_attributes!(:user => User.first, :language => StatementDocument.languages("en").first, :level => StatementDocument.language_levels("intermediate").first)
      end
