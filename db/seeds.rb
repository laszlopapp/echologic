...
["English","Englisch","Ingles","Inglês","Inglés"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('en'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => value, :context => "")
end
["German","Deutsch","Aleman","Alemão","Alemán"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('de'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => value, :context => "")
end
["French","Französisch","Français","Francês","Francés"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('fr'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => value, :context => "")
end
["Portuguese","Portugiesisch","Portugais","Português","Portugués"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('pt'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => value, :context => "")
end
["Spanish","Spanisch","Espagnol","Espanhol","Español"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('es'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => value, :context => "")
end

# Language Levels
["Mother Tongue","Muttersprache","Langue Maternelle","Língua Materna","Lengua Materna"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('mother_tongue'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => value, :context=> "")
end
["Advanced","Fortgeschritten","Avancé","Avançado","Avanzado"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('advanced'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => value, :context=> "")
end
["Intermediate","Mittelstufe","Intermédiaire","Intermédio","Intermedio"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('intermediate'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => value, :context=> "")
end
["Basic","Grundkenntnisse","Basique","Básico","Basico"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('basic'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => value, :context=> "")
end

# Web Addresses
Language.all.length.times do |index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('email'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => "E-mail", :context=> "")
  EnumValue.create(:enum_key => EnumKey.find_by_code('homepage'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => "Homepage", :context=> "")
  EnumValue.create(:enum_key => EnumKey.find_by_code('blog'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => "Blog", :context=> "")
  EnumValue.create(:enum_key => EnumKey.find_by_code('xing'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => "Xing", :context=> "")
  EnumValue.create(:enum_key => EnumKey.find_by_code('linkedin'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => "LinkedIn", :context=> "")
  EnumValue.create(:enum_key => EnumKey.find_by_code('facebook'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => "Facebook", :context=> "")
  EnumValue.create(:enum_key => EnumKey.find_by_code('twitter'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => "Twitter", :context=> "")
end
["Other","Andere","Autre","Outro","Otro"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('other'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => value, :context=> "")
end

# Organization Types
["NGO","NRO","ONG","ONG","ONG"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('ngo'), :code => EnumKey.find_by_type_and_key('Language', index+1).code, :value => value, :context=> "")
end
["Political","Politisch","Politique","Política","Política"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('political'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
["Scientific","Wissenschaftlich","Scientifique","Científica","Científica"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('scientific'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
["Trade Union","Gewerkschaft","Syndicat","Sindicato","Sindicato"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('trade_union'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
["Social Business","Sozialbetrieb","Activité Sociale","Actividade Social","Actividad Social"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('social_business'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
["Profit-Driven Business","Gewinnorientierte Firma","Firma à but lucratif","Firma com fins lucrativos","Firma de lucro"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('profit_driven_business'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end

# Tag Contexts
["Affection","Betroffenheit","Affection","Afeição","Afecto"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('affection'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
["Engagement","Engagement","Engagement","Compromisso","Compromisso"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('engagement'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
["Expertise","Expertise","Expertise","Especialidade","Peritaje"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('expertise'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
["Decision Making","Entscheidung","Décision","Decisão","Decisión"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('decision_making'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
["Field of Work","Arbeitsfeld","Domaine de travail","Domínio de Trabalho","Área de Trabajo"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('field_work'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
["Field of Activity","Betätigungsfeld","Domaine d'activité","Domínio de Actividade","Área de Actividad"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('field_activity'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
["Topic","Thema","Sujet","Tópico","Tema"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code('topic'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end

# Statement States
["New","Neu","Neuf","Novo","Nuevo"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code_and_type('new','StatementState'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
["Published","Veröffentlicht","Publié","Publicado","Publicado"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code_and_type('published','StatementState'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end

# Statement States
["New","Neu","Neuf","Novo","Nuevo"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code_and_type('created','StatementAction'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
["Edit","Editieren","Éditer","Editar","Editar"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code_and_type('updated','StatementAction'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
["Translate","Übersetzen","Traduire","Traduzir","Traducir"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code_and_type('translated','StatementAction'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
["Incorporate","Einfügen","Incorporer","Incorporar","Incorporar"].each_with_index do |value,index|
  EnumValue.create(:enum_key => EnumKey.find_by_code_and_type('incorporated','StatementAction'), :code => EnumKey.find_by_type_and_key('Language',index+1).code, :value => value, :context=> "")
end
