...
ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :questions,
                :member => [:new_translation, :create_translation, :publish, :cancel, :upload_image, :reload_image],
                :as => 'discuss/questions' do |question|
    question.resources :proposals,
                       :member => [:echo, :unecho, :new_translation, :create_translation, :incorporate, :cancel, :upload_image, :reload_image] do |proposal|
