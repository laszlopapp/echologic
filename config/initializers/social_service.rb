...
SocialService.instance.signinup_providers=%w(facebook twitter google linkedin yahoo openid)
SocialService.instance.connectable_providers=%w(facebook twitter yahoo! linkedin google)
